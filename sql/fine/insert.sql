...
insert into item(item_name, users_id, caregory_id, state_id) values ('reward', 1, 1, 1);
insert into item(item_name, users_id, caregory_id, state_id) values ('vacation pay', 2, 1, 2);
